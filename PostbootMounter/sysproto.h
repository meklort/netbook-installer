 ...
 * created from /SourceCache/xnu/xnu-1456.1.25/bsd/kern/syscalls.master
 */
...
#define munge_wwwlw  NULL 
#define munge_wwwlww  NULL
#define munge_wwlwww  NULL 
#define munge_wwwwl  NULL 
#define munge_wwwwlw  NULL 
#define munge_wwwwwl  NULL 
#define munge_wwwwwwlw  NULL 
#define munge_wsw  NULL 
#define munge_wws  NULL 
#define munge_wwwsw  NULL 
#define munge_llllll  NULL 
#endif // ! __arm__
#ifdef __ppc__
...
struct psynch_cvbroad_args {
	...
	char diffgen_l_[PADL_(uint32_t)]; uint32_t diffgen; char diffgen_r_[PADR_(uint32_t)];
	char mutex_l_[PADL_(user_addr_t)]; user_addr_t mutex; char mutex_r_[PADR_(user_addr_t)];
	char mgen_l_[PADL_(uint32_t)]; uint32_t mgen; char mgen_r_[PADR_(uint32_t)];
	char ugen_l_[PADL_(uint32_t)]; uint32_t ugen; char ugen_r_[PADR_(uint32_t)];
	char tid_l_[PADL_(uint64_t)]; uint64_t tid; char tid_r_[PADR_(uint64_t)];
...
struct psynch_cvwait_args {
	...
	char mgen_l_[PADL_(uint32_t)]; uint32_t mgen; char mgen_r_[PADR_(uint32_t)];
	char ugen_l_[PADL_(uint32_t)]; uint32_t ugen; char ugen_r_[PADR_(uint32_t)];
	char sec_l_[PADL_(uint64_t)]; uint64_t sec; char sec_r_[PADR_(uint64_t)];
	char usec_l_[PADL_(uint64_t)]; uint64_t usec; char usec_r_[PADR_(uint64_t)];
};
...
int psynch_cvbroad(struct proc *, struct psynch_cvbroad_args *, int *);
int psynch_cvsignal(struct proc *, struct psynch_cvsignal_args *, int *);
...
#else
#endif
int thread_selfid(struct proc *, struct thread_selfid_args *, user_addr_t *);
